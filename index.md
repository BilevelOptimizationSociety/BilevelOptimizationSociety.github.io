...
The BOS acts in accordance with its [bylaws](https://github.com/BilevelOptimizationSociety/BilevelOptimizationSociety.github.io/blob/gh-pages/BOS_bylaws.pdf).

It's funding committe consists of 
...
This committee is right now organizing the elections of the first committee of the BOS (COBOS). Stay tuned!
...
- Jos\'{e}-Fernando Camacho-Vallejo (Tecnologico de Monterrey, Mexico)
- Carmen Gal\'{e} (Universidad de Zaragoza, Spain)
- Martine Labb\'{e} (Université Libre de Bruxelles, Belgium)
...
- A person becomes a BOS member by completing and submitting a membership form prescribed by COBOS. Membership of the MOS is not a prerequisite for membership of the BOS.
